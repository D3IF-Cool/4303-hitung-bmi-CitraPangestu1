...
import org.d3if3023.hitungbmi.data.HitungBmi
import org.d3if3023.hitungbmi.databinding.ItemHistoriBinding
import org.d3if3023.hitungbmi.db.BmiEntity
...
class HistoriAdapter : RecyclerView.Adapter<HistoriAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        private val binding: ItemHistoriBinding) : RecyclerView.ViewHolder(binding.root) {
